...
public abstract class MetadataExtensionFunctionalTestCase extends ExtensionFunctionalTestCase {
  ...
  protected void assertExpectedType(MetadataType type, Type expectedType) {
    assertThat(type, is(TYPE_LOADER.load(expectedType)));
  }
  ...
  protected void assertExpectedType(Typed typedModel, Type expectedType, boolean isDynamic) {
    assertExpectedType(typedModel, TYPE_LOADER.load(expectedType), isDynamic);
  }
  ...
  //
  //private void assertExpectedType(MetadataType resolvedType, MetadataType type) {
  //  assertThat(resolvedType, is(type));
  //}
  //
